...
# This application visualizes Bh's IMU data. Tested to work under Ubuntu and 
...
vertices = [
    -1.1, -1.5, -0.6,  -1.1, -1.5,  0.6,  -1.1,  1.5,  0.6,  -1.1,  1.5, -0.6,
     1.1, -1.5, -0.6,   1.1, -1.5,  0.6,   1.1,  1.5,  0.6,   1.1,  1.5, -0.6,
    -1.1, -1.5, -0.6,  -1.1, -1.5,  0.6,   1.1, -1.5,  0.6,   1.1, -1.5, -0.6,
    -1.1,  1.5, -0.6,  -1.1,  1.5,  0.6,   1.1,  1.5,  0.6,   1.1,  1.5, -0.6,
    -1.1, -1.5, -0.6,  -1.1,  1.5, -0.6,   1.1,  1.5, -0.6,   1.1, -1.5, -0.6,
...
colors = [
    0.10, 0.22, 0.15,  0.10, 0.22, 0.15,  0.10, 0.22, 0.15,  0.10, 0.22, 0.15,
    0.10, 0.22, 0.15,  0.10, 0.22, 0.15,  0.10, 0.22, 0.15,  0.10, 0.22, 0.15,
    0.20, 0.30, 0.25,  0.20, 0.30, 0.25,  0.20, 0.30, 0.25,  0.20, 0.30, 0.25,
    0.20, 0.30, 0.25,  0.20, 0.30, 0.25,  0.20, 0.30, 0.25,  0.20, 0.30, 0.25,
    0.30, 0.38, 0.34,  0.30, 0.38, 0.34,  0.30, 0.38, 0.34,  0.30, 0.38, 0.34,
    0.30, 0.38, 0.34,  0.30, 0.38, 0.34,  0.30, 0.38, 0.34,  0.30, 0.38, 0.34]
...
glutCreateWindow("Bithollow IMU visualizer")
...
glClearColor(0.044, 0.347, 0.955, 1)
glClearDepth(1.0)
glDepthFunc(GL_LESS)
